  ...
  return (
    <>
      <a
        ...
        className="fixed left-4 top-4 z-50 rounded-md p-2 text-slate-800 outline-none ring-slate-400 transition-colors hover:bg-slate-200/80 hover:text-slate-950 focus-visible:ring-2"
      ...
      <main className="mx-auto max-w-4xl space-y-6 p-4 md:p-8">
        ...
        <section className="rounded-xl bg-white p-4 shadow-sm">
          ...
          <p
            id="status"
            className={statusIsError ? "mt-3 text-sm text-red-600" : "mt-3 text-sm text-slate-600"}
          >
            {statusMessage}
          </p>
        </section>
