...
/** Standard full-color Google mark for the sign-in button (do not recolor). */
export function GoogleGMonogram(props: SVGProps<SVGSVGElement>) {
  const { className, width = 18, height = 18, ...rest } = props;
  return (
    <svg
